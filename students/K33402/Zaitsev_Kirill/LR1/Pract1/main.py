...
temp_bd = [
    {
        ...
        "description": "Сделать первую лабораторную работу по инструментам веб-разработки",
    ...
    {
        "id": 2,
        "title": "Посетить тренировку сборной",
        "description": "Прийти на тренировку сборной ИТМО",
        "deadline": date(2024, 3, 24),
        "priority": "Medium",
        "status": "To do",
        "category": {
            "id": 2,
            "title": "Сборная",
            "description": "Закрываем физру"
        },
        "notes":
            [{
                "id": 1,
                "content": "Тыкнуть менеджера, чтобы поставил баллы",
            }]
    }
]
